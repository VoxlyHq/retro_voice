...
class UserVideo:
    def __init__(self, lang="jp", disable_dialog=False, disable_translation=False, enable_cache=False, translate="", textDetector=None, debug_bbox=False, crop_height=None):
        ...
        self.frameProcessor = FrameProcessor(lang, disable_dialog, method=OCREngine.CLAUDE, detection_method=DETEngine.FAST, translation_method=TranslationEngine.CLAUDE)
