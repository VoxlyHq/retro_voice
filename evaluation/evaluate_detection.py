...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
                    ...
                    if matchMat.sum(axis=0)[detNum] > 0:
                        ...
                        for gtNum in range(len(gtRectMat)):
                            if matchMat[gtNum, detNum] > 0:
                                ...
                                methodIoUSum += iouMat[gtNum, detNum]
                                numMatchedPairs += 1
    ...
    methodIoU = 0 if numMatchedPairs == 0 else methodIoUSum / numMatchedPairs
    
    methodMetrics = {'recall':methodRecall, 'precision':methodPrecision, 'hmean':methodHmean, 'IoU':methodIoU, 'AP':AP }
