...
class TestDialogueOverlay(unittest.TestCase):
    def setUp(self):
        ...
        self.video_stream = VideoStreamWithAnnotations(background_task=None, background_task_args={'translate' : ''}, show_fps=False,
                                                       frameProcessor=FrameProcessor('en'), textDetector=TextDetectorFast('pretrained/fast_tiny_ic15_736_finetune_ic17mlt.pth',checkpoint='checkpoints/checkpoint.pth.tar'))
